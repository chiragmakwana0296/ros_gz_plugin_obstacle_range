...
#include "ros_gz_example_gazebo/ObstacleRange.hh"
...
// GZ_REGISTER_SENSOR_PLUGIN(gz::sensors::Lidar)
...
bool Lidar::Load(const sdf::Sensor &_sdf)
{
  ...
  if ("ObstacleRange" != type)
  {
    gzerr << "Trying to load [ObstacleRange] sensor, but got type ["
